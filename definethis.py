#! /usr/bin/python
########################################################################
# DefineThis finds info on the highlighted text and displays it.
...
if (('-S' in sys.argv)==True) or (('--setup-shortcuts' in sys.argv)==True):
	...
	print "DefineThis finds info on the highlighted text and displays it."
	...
	print "    Installs shortcuts for xfce <super>+d to run the program"
	print "-S or --setup-shortcuts"
	print "    Installs shortcuts for xfce <super>+d to all users on the system"
	print "Running the program without arguments will speak the currently"
	print "    highlighted text."
	print '#####################################################################'
	print 'Highlight the phrase below and hit "<super>+d" to test the program.'
	print 
	print '                          Hello World'
	print 
else:
